...
SEMESTER_DELETED = 'The semester has been removed from your plan.'
NON_EMPTY_SEMESTER = 'Cannot remove a semester that has one or more courses in it.'
CANNOT_REMOVE_FIRST_SEMESTER = 'Cannot remove first semester.'
MAX_YEAR_LIMIT = 'A maximum of 10 years is allowed to complete the program'
NEW_SEMESTER_ADDED = 'A new semester has been added to your plan.'